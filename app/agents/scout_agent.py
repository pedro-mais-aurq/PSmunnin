"""
Scout Agent — Coleta de empresas via Google Maps Places API.
Responsabilidade: buscar empresas candidatas em uma região/nicho.
"""
import os
...
class ScoutAgent:
    """
    Agente de coleta. Não usa LLM (determinístico).
    Integração com Google Maps Places API (Text Search + Place Details).
    """
    ...
    async def search(
        ...
        """
        Busca empresas via Text Search e expande detalhes via Place Details.
        """
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            while len(leads) < max_results:
                ...
                for place in results:
                    ...
                    # Place Details para telefone, website, etc.
